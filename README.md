...
데이터 처리, 성능 최적화, AI 모델 서빙에 관심있는 백엔드 개발자입니다.

---
### 🎓 Experience
* ⭐**SKALA (SK AI Leader Academy) 1기 - 2025**
* ⭐**SSAFY (삼성 청년 SW 아카데미) 11기 - 2024**
* 42Seoul 10기 - 2023
* 멋쟁이사자처럼 대학 10기 - 2022

### 🏆 Awards
* 🥈 삼성 청년 SW 아카데미 공통 프로젝트 우수상 - 2024
* 🥈 신한은행 해커톤 우수상 - 2024
* 🥇 강원 ICT 이노베이션스퀘어 해커톤 대상 - 2023
* 🥇 춘천시 빅데이터 분석 경진대회 대상 - 2022
---
...
| 프로젝트          | 기간 | 기술 스택          | 설명               |
| ------------- | -- | --------------- | ---------------- |
| 🛡️ Shield | 2025.05.23 ~ 2025.07.07 |  Java, Spring Boot, Python, FastAPI, PostgreSQL, Vue.js, LangChain, LangGraph | 법인카드 비용 이상징후 탐지 서비스 |
| 💰 가계쀼 | 2024.08.16 ~ 2024.08.31 | Java, Spring Boot, Python, FastAPI, MySQL, Dart, Flutter | 신혼부부 공동 자산 관리 애플리케이션     |
